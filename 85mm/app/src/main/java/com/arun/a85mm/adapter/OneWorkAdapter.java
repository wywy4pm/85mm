...
public class OneWorkAdapter extends BaseRecyclerAdapter<WorkListItemBean> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof WorkListItemHolder) {
            ...
            rewardHolder.setData(contexts.get(), getItem(position), onTagWorkListener);
        }
    }
    ...
    private static class RewardHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(final Context context, final WorkListItemBean item, final OnTagWorkListener onTagWorkListener) {
            if (item != null && item.productInfo != null) {
                ...
                text_reward.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (onTagWorkListener != null) {
                            onTagWorkListener.onUserAward(item.id);
                        }
                    }
                });
            }
